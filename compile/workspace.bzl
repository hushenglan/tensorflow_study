...
def tf_workspace(path_prefix="", tf_repo_name=""):
  ...
  native.new_http_archive(
      name = "mkl_dnn",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/b01e3a55a07be62172e713bcd2644c5176360212.tar.gz",
      ],
  ...
  native.http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/cc4bed2d74f7c8717e31f9579214ab52a9c9c610.tar.gz",
      ],
  ...
  native.new_http_archive(
      name = "eigen_archive",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/429aa5254200.tar.gz",
      ],
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/0e906ebc527eab1cdbf7adabff5b474da9562e9f.tar.gz",
      ],
  )
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/1.8.1.tar.gz",
      ],
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/253f7955c6a1fd805408fba2e42ac6d45b312d15.tar.gz",
      ],
  ...
  native.http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/b94b7cd42e9f02673cd748c1ac1d16db4052514c.tar.gz",
      ],
  ...
  native.http_archive(
      name = "gemmlowp",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/010bb3e71a26ca1d0884a167081d092b43563996.zip",
      ],
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/816a4ae622e964763ca0862d9dbd19324a1eaf45.tar.gz",
      ],
  ...
  native.new_http_archive(
      name = "highwayhash",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/dfcb97ca4fe9277bf9dc1802dd979b071896453b.tar.gz",
      ],
  ...
  native.new_http_archive(
      name = "nasm",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/nasm-2.12.02.tar.bz2",
      ],
  ...
  temp_workaround_http_archive(
      name = "jpeg",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/1.5.1.tar.gz",
      ],
  ...
  native.new_http_archive(
      name = "png_archive",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/v1.2.53.tar.gz",
      ],
  ...
  native.new_http_archive(
      name = "sqlite_archive",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/sqlite-amalgamation-3200000.zip",
      ],
  ...
  native.new_http_archive(
      name = "gif_archive",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/giflib-5.1.4.tar.gz",
      ],
  ...
  native.new_http_archive(
      name = "six_archive",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/six-1.10.0.tar.gz",
      ],
  ...
  native.http_archive(
      name = "absl_py",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/231e3870b976c1dc61dce1749138661d21556028.tar.gz",
      ],
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/backports.weakref-1.0rc1.tar.gz",
      ],
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/1.0.tar.gz",
      ],
  ...
  patched_http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/b04e5cba356212e4e8c66c61bbe0c3a20537c5b9.tar.gz",
      ],
  ...
  native.http_archive(
      name = "nsync",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/93815892dddafe9146a5f7e7042281d59d0f4323.tar.gz",
      ],
  ...
  native.http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/9816b96a6ddc0430671693df90192bbee57108b6.zip",
      ],
  ...
  native.http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/f8a0efe03aa69b3336d8e228b37d4ccb17324b88.tar.gz",
      ],
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/pcre-8.39.tar.gz",
      ],
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/swig-3.0.8.tar.gz",
      ],
  ...
  temp_workaround_http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/curl-7.49.1.tar.gz",
      ],
  ...
  native.http_archive(
      name = "grpc",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/54e8f37e537794c2d814c1604c1282125f64f093.tar.gz",
      ],
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/c894b9e59f02203dbe4e2be657572cf88c4230c3.tar.gz",
      ],
  ...
  temp_workaround_http_archive(
      name = "llvm",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/8d26b8bee4d8e7230870a600bc968c7ee8cf6f67.tar.gz",
      ],
  ...
  native.new_http_archive(
      name = "lmdb",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/LMDB_0.9.19.tar.gz",
      ],
  ...
  native.new_http_archive(
      name = "jsoncpp_git",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/11086dd6a7eba04289944367ca82cea71299ed70.tar.gz",
      ],
  ...
  native.http_archive(
      name = "boringssl",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/a0fb951d2a26a8ee746b52f3ba81ab011a0af778.tar.gz",
      ],
  ...
  native.new_http_archive(
      name = "zlib_archive",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/zlib-1.2.8.tar.gz",
      ],
  ...
  native.new_http_archive(
      name = "fft2d",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/fft.tgz",
      ],
  ...
  temp_workaround_http_archive(
      name = "snappy",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/1.1.4.tar.gz",
      ],
  ...
  temp_workaround_http_archive(
      name = "nccl_archive",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/03d856977ecbaac87e598c0c4bafca96761b9ac7.tar.gz",
      ],
  ...
  temp_workaround_http_archive(
      name = "aws",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/1.0.90.tar.gz",
      ],
  ...
  temp_workaround_http_archive(
      name = "jemalloc",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/4.4.0.tar.gz",
      ],
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/c0fb62ec88c411cc91194465e54db2632845b650.tar.gz",
      ],
  ...
  native.new_http_archive(
      name = "cub_archive",
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/1.7.4.zip",
      ],
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/3732784c45cfb040a5b0936951d196f83a12ea17.tar.gz",
      ],
  ...
  native.http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/af4681c3d19f063f090222ec3d04108c4e0ca255.tar.gz",
      ],
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/0f77d9d182265259b135dad949230ecbf1a2633d.tar.gz",
      ],
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/971a68110e4fc1bace10fcb6deeb189e7e1a34ce.tar.gz",
      ],
  )
  ...
  native.http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/double-conversion-5664746c5e64dc265e7fbc1a890a6698e6ad0ebb.zip",
      ],
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://10.123.11.77:8080/tensorflow_deps/mobilenet_v1_224_android_quant_2017_11_08.zip",
      ],
  )
